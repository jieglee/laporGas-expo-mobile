...
import ForgotPasswordModal from "@/components/user/Auth/ForgotPasswordModal";
        ...
        <KeyboardAvoidingView style={s.root} behavior={Platform.OS === "ios" ? "padding" : undefined}>
            <ScrollView contentContainerStyle={s.scroll} keyboardShouldPersistTaps="handled">
                ...
                <View style={s.header}>
                    ...
                    <Text style={s.appName}>LaporGas</Text>
                    <Text style={s.tagline}>Platform Pengaduan Masyarakat</Text>
                </View>

                <View style={s.card}>
                    <Text style={s.cardTitle}>Selamat datang kembali</Text>
                    <Text style={s.cardSub}>Masuk dengan akun yang sudah terdaftar</Text>
                    ...
                    <View style={s.footer}>
                        ...
                        <TouchableOpacity onPress={() => router.push("/(auth)/register" as any)}>
                            <Text style={s.footerLink}>Daftar</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
...
const s = StyleSheet.create({
    ...
    forgotText: { fontSize: 12, fontWeight: "600", color: ORANGE },
    btn: {
