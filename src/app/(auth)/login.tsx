...
export default function LoginPage() {
    ...
    // Validasi password minimal 6 karakter di FE
    ...
    try {
        ...
        if (typeof data === "string") {
            ...
            msg = data[0]?.message ?? "Email atau password salah";
        } else if (data?.errors && Array.isArray(data.errors)) {
            msg = data.errors[0]?.message ?? "Email atau password salah";
        }
        ...
        <KeyboardAvoidingView style={styles.root} behavior={Platform.OS === "ios" ? "padding" : undefined}>
            <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
                ...
                <View style={styles.card}>
                    ...
                    <Text style={styles.cardSub}>Masuk dengan akun yang sudah terdaftar</Text>
                    ...
                    <View style={styles.fields}>
                        ...
                        <View style={styles.fieldGroup}>
                            ...
                            <View style={styles.pwWrap}>
                                <TextInput
                                    style={[styles.input, { flex: 1, borderWidth: 0 }, error && styles.inputError]}
                                    placeholder="••••••••"
                                    placeholderTextColor="#c9a892"
                                    value={password}
                                ...
                                <TouchableOpacity onPress={() => setShowPw(!showPw)} style={styles.eyeBtn}>
                                    {showPw
                                        ? <EyeOff size={16} color="#a8856b" />
                                        : <Eye size={16} color="#a8856b" />
                                    }
                                </TouchableOpacity>
                            </View>
                        </View>
