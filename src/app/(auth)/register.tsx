                ...
                <View style={styles.header}>
                    <View style={styles.logoWrap}>
                        <Svg width={36} height={36} viewBox="0 0 24 24">
                            <Path fill="#fff" fillRule="evenodd" d={LOGO_PATH} clipRule="evenodd" />
                        </Svg>
                    </View>
                    <Text style={styles.appName}>LaporGas</Text>
                    <Text style={styles.tagline}>Buat akun dan mulai buat laporan</Text>
                </View>

                {/* Card */}
                <View style={styles.card}>
                    <Text style={styles.cardTitle}>Buat Akun Baru</Text>
                    <Text style={styles.cardSub}>Lengkapi data diri kamu</Text>
                    ...
                    <View style={styles.fields}>
                        ...
                        <View style={styles.fieldGroup}>
                            ...
                            <View style={[styles.pwWrap, pwMismatch && styles.pwWrapError, pwMatch && styles.pwWrapMatch]}>
                                <TextInput
                                    style={[styles.input, { flex: 1, borderWidth: 0 }]}
                                    ...
                                    autoCapitalize="none"
                                />
                                {pwMatch && <CheckCircle size={16} color="#10B981" style={{ marginRight: 14 }} />}
                                {!pwMatch && (
                                    <TouchableOpacity onPress={() => setShowConfirm(!showConfirm)} style={styles.eyeBtn}>
                                        {showConfirm ? <EyeOff size={16} color="#a8856b" /> : <Eye size={16} color="#a8856b" />}
                                    </TouchableOpacity>
                                )}
                            </View>
                            {pwMismatch && (
                                <Text style={styles.pwHint}>Password tidak cocok</Text>
                            )}
                        </View>
                    </View>
...
const styles = StyleSheet.create({
    ...
    appName: { fontSize: 26, fontWeight: "800", color: "#1a0e08", letterSpacing: -0.5, marginBottom: 4 },
    tagline: { fontSize: 13, color: "#a8856b" },
    ...
    cardTitle: { fontSize: 20, fontWeight: "800", color: "#1a0e08", marginBottom: 4 },
    cardSub: { fontSize: 13, color: "#a8856b", marginBottom: 20 },
    ...
    input: {
        borderWidth: 1, borderColor: "#f0e6dc", borderRadius: 12,
        paddingHorizontal: 14, paddingVertical: 13,
        fontSize: 14, color: "#1a0e08", backgroundColor: "#fafaf8",
    },
    pwWrap: {
    ...
    pwWrapError: { borderColor: "#FECACA" },
    pwWrapMatch: { borderColor: "#6EE7B7" },
    eyeBtn: { paddingHorizontal: 14 },
    pwHint: { fontSize: 11, color: "#EF4444", marginTop: 4 },
